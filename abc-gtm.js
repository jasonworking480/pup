...
if (window.location.href.indexOf("inventory/certified-used-") != -1){
    var vdpCpoEprice = document.querySelectorAll('.vdp-pricebox-cta-button');
    var vdpCpoEprice2 = document.querySelectorAll('.online-shopper-cta-button');

    for(var i = 0; i < vdpCpoEprice.length; i++){
        vdpCpoEprice[i].addEventListener("click", myFunk);
    }

    for(var i = 0; i < vdpCpoEprice2.length; i++){
        vdpCpoEprice2[i].addEventListener("click", myFunk);
    }
}
...
if (window.location.href.indexOf("inventory/new-") != -1){
    ...
    for(var j = 0; i < vdpNewEprice2.length; i++){
...
// VDP CPO Pageview
const vdpCpoPage = () => {
    if(window.location.href.indexOf("certified-used") != -1 && window.location.href.indexOf("inventory") != -1){
        console.log('VDP Used pageview');
